	...
	<div class="contact-form">
		<div class="container">
			<div class="section-header">
				<h2 class="section-title">Buddy 지원서 채용페이지(관리자 전용)</h2>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-xs-12">
					<div class="contact-block">
						<form id="contactForm" action="${pageContext.request.contextPath }/admin/buddy/buddyRegister" method="post"
							role="form">
							<!-- 페이징 추가 -->
								...
								<div class="col-md-7 border-right">
									...
									<div class="form-group">
										<input type="text" name="zipCode" id="sample6_postcode"
											class="form-control"
											value='<c:out value="${form.zipCode }"/>'
											placeholder="우편번호를 입력하세요" readonly="true">
										<div class="help-block with-errors"></div>
									</div>
									...
									<div class="form-group">
										<input type="text" name="loc" id="sample6_address"
											class="form-control" value='<c:out value="${form.loc }"/>'
									...
									<div class="form-group">
										<input type="text" name="inputLoc" id="sample6_extraAddress"
											class="form-control"
											value='<c:out value="${form.inputLoc }"/>'
									...
									<div class="form-group">
										<input type="text" name="servLoc" id="msg_subject"
											...
											value='<c:out value="${form.servLoc }"/>'
									...
									<div class="submit-button" style="margin-top: 20px;">
										<button class="btn btn-common btn-effect" id="submit"
											type="submit">채용하기</button>
										<div id="msgSubmit" class="h3 hidden"></div>
										<div class="clearfix"></div>
									</div>
										<span>* 채용하기 버튼을 누르기 전, 지원자의 지원 번호를 확인하시고 지원서 관리페이지에서<br>해당하는 지원서를 반드시 삭제하시기 바랍니다.</span>	
								...
								<div class="col-md-5">
									<div style="text-align: center">
										...
										<img style="width: 100%; height: auto;"
											src="${pageContext.request.contextPath }/resources/img/buddy/<c:out value='${form.pic }'/>">
									</div>
