    ...
    <section id="portfolios" class="section">
      ...
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title">죄송합니다</h2>
          <span>matching Fail!</span>
          <p class="section-subtitle"></p>
        </div>
        <div class="row">          
          <div class="col-md-12">
            <!--matching-complete image div-->
            <div class="p-3 py-5" > 
              <div class="mt-5 text-center">
                <img src="${pageContext.request.contextPath }/resources/img/portfolio/match_success.gif" alt="" />
              </div>
              <div class="mt-5 text-center">
                <p><br/><br/></p>
                <h2 class="section-title" style="font-size: 20px;">아직 지역에 알맞은 Buddy가 존재하지 않습니다! <br/>빠른시일 내에 매칭 후 알림드리도록 하겠습니다.</h2>
              </div>
            </div>
            <div class="controls text-center">              
              <a class="filter btn btn-common btn-effect" href="${pageContext.request.contextPath }/">메인 화면으로 </a>
            </div>
          </div>
        </div>
      <!-- Container Ends -->
