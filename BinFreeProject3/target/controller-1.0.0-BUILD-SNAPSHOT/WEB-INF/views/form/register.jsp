			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-xs-12">
					...
					<div class="contact-block">
						<form id="contactForm" action="register" method="post" role="form">
							<div class="row">
								<div class="col-md-7 border-right">
									...
									<div class="form-group">
										<input type="text" placeholder="우편번호를 입력하세요" name="zipCode" id="sample6_postcode" class="form-control"> 
									...
									<div class="form-group">
										<input type="text" placeholder="주소를 입력하세요" name="loc"
											id="sample6_address" class="form-control">
										<div class="help-block with-errors"></div>
									</div>
									
									<div class="form-group">
										<input type="text" placeholder="상세주소를 입력하세요" name="inputLoc"
									...
									<div class="form-group">
										<input type="text" placeholder="담당하고 싶은 지역을 입력해주세요"
											name="servLoc" id="msg_subject" class="form-control" required
								...
								<div class="col-md-5">
									...
									<div style="margin-top: 17.5px; text-align: center;">
										<label class="btn btn-common btn-effect" for="input-file">사진
											선택</label>
										<div class="clearfix"></div>
									</div>
								</div>
